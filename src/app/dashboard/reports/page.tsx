...
import { Loader2, TrendingUp, AlertTriangle, ShieldCheck, FileAudio, Download } from "lucide-react"
  ...
  useEffect(() => {
    async function fetchAudits() {
      try {
        ...
        const { data: audits, error: dbError } = await query
        ...
        setAgentData(aggregatedAgentData)
